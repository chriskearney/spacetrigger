...
public interface PConstants {
    ...
    static final double HALF_PI    = PI / 2.0f;
    static final double THIRD_PI   = PI / 3.0f;
    static final double QUARTER_PI = PI / 4.0f;
    static final double TWO_PI     = PI * 2.0f;
    static final double TAU        = PI * 2.0f;
