...
public class PVector implements Serializable {
    ...
    static public final double atan2(double a, double b) {
     ...
     */
    public void lerp(PVector v, double amt) {
        x = lerp(x,v.x,amt);
        y = lerp(y,v.y,amt);
        z = lerp(z,v.z,amt);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(pVector.x, x) == 0 && Double.compare(pVector.y, y) == 0 && Double.compare(pVector.z, z) == 0 && Arrays.equals(array, pVector.array);
    }
